  ...
  export default {
    ...
    methods: {
      ...
      async deleteItemConfirm () {
        ...
        var deleted = await axios.delete(`http://localhost:3000/api/classschedule/delete/${this.editedItem._id}`)
      ...
      async save () {
        if (this.editedIndex > -1) {
          ...
          var updated = await axios.post('http://localhost:3000/api/classschedule/update', this.editedItem)
